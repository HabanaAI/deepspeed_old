...
class DeepSpeedEngine(Module):
    ...
    def __init__(
        ...
        if self.fp16_enabled() and args.use_hpu:
    ...
    def zero_hpu_use_async_collectives(self):
        return self._config.zero_config.hpu_use_async_collectives
    ...
    def _configure_zero_optimizer(self, optimizer):
        ...
        if zero_stage <= ZeroStageEnum.gradients:
            ...
            optimizer = DeepSpeedZeroOptimizer(
                ...
                hpu_use_async_collectives=self.zero_hpu_use_async_collectives())
