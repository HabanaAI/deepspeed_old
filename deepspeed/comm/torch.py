...
from deepspeed.runtime.utils import staged_all_reduce
...
class TorchBackend(Backend):
    ...
    def all_reduce(self,
        ...
        #TODO remove - SW-118202
        if op in [torch.distributed.ReduceOp.MIN, torch.distributed.ReduceOp.MAX]:
            return staged_all_reduce(tensor=tensor,
                                     op=op,
                                     group=group,
                                     async_op=async_op)
